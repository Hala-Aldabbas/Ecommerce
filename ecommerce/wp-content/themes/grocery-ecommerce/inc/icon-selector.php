...
class Grocery_Ecommerce_Icon_Selector extends WP_Customize_Control{
      public $type = 'icon';
            ...
            <label>
                  ...
                  <ul class="icon-list">
                      <div class="social-icon-search">
                          <input class="socialInput" type="text" placeholder="<?php echo esc_attr('Search Icon', 'grocery-ecommerce'); ?>">
                      </div>
                    <?php
                    $grocery_ecommerce_font_awesome_icon_array = grocery_ecommerce_font_awesome_icon_array();
                    foreach ($grocery_ecommerce_font_awesome_icon_array as $grocery_ecommerce_font_awesome_icon) {
                            $icon_class = $this->value() == $grocery_ecommerce_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($grocery_ecommerce_font_awesome_icon).'"></i>
                            <span class="grocery-ecommerce-social-class">'.esc_attr($grocery_ecommerce_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                  </ul>
...
function grocery_ecommerce_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
}
add_action( 'customize_controls_enqueue_scripts', 'grocery_ecommerce_customizer_script' );

if(!function_exists('grocery_ecommerce_font_awesome_icon_array')){
    function grocery_ecommerce_font_awesome_icon_array(){
