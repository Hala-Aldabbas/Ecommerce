...
echo'<!--Register with miniOrange-->
	<form name="f" method="post" action="">
		<input type="hidden" name="option" value="moppm_register_customer" />
		<input type="hidden" name="nonce" value='.esc_html (wp_create_nonce("moppm-account-nonce")).' >
	 ...
	 <form name="f" method="post" action="" class="moppm_verify_customerform">
        <input type="hidden" name="option" value="moppm_goto_verifycustomer">
         <input type="hidden" name="nonce" value='. esc_html(wp_create_nonce("moppm-account-nonce")).' >
       </form>';
?>
    <script>
        ...
        jQuery('a[href=\"#Moppm_account_exist\"]').click(function (e) {
            jQuery('.moppm_verify_customerform').submit();
        });
